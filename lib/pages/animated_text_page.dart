...
class AnimatedTextExamplePage extends StatefulWidget {
  const AnimatedTextExamplePage({Key? key}) : super(key: key);

  @override
  _AnimatedTextExamplePageState createState() => _AnimatedTextExamplePageState();
}

class _AnimatedTextExamplePageState extends State<AnimatedTextExamplePage> {
